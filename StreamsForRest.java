...
public class StreamsForRest {
	...
	public static void main(String[] args) {
		List<String> names = Arrays.asList("Reo", "Pragati", "Bip", "Simba");
		...
		List<Integer> withdrawls = transaction.stream().filter(c -> c < 0).collect(Collectors.toList());
		...
		List<String> na = Arrays.asList("Pragati", "Reo", "Biplov", "simba");
